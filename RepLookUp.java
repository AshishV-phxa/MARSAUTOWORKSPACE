...
public class RepLookUp extends BaseClass 
{
	...
	@FindBy(xpath = "//td[contains(@class,'GridLinkLabelText')][1]//following::a[normalize-space(text())='Sidharth Sid']")
	WebElement clickrep;
	
	@FindBy(xpath="//*[@class='GridLinkLabelText']")
	WebElement LookupByClassLink;
	...
	@FindBy(xpath ="(//*[contains(text(),' Rep Details')]//following::i)[1]")
	WebElement RepDetails;
	    
	@FindBy(xpath ="//*[normalize-space(text())='Middle Name']//following::div[@class='text-truncate'][1]")
	WebElement MiddleName;
	@FindBy(xpath="//*[normalize-space(text())='Middle Name']//following::input[contains(@class, 'floating-label')][1]")
	...
	@FindBy(xpath="//input[contains(@class, 'floating-label')]//following::i[@id='saveImg'][1]")
	WebElement Save1;
	...
	@FindBy(xpath="//div[normalize-space(text())='Email']//following::div[@class='ValueText'][1]")
	WebElement RepEmail;
	@FindBy(xpath="//*[normalize-space(text())='Email']//following::input[contains(@class, 'floating-label')][1]")
	...
	WebElement AUM_CT;
	@FindBy(xpath="//*[normalize-space(text())='Total AUM (Self Reported)']//following::input[contains(@class, 'floating-label')][1]//following::i[@id='saveImg'][1]")
	WebElement SaveImg2;
	...
	// Ctrl + Click 
	 ...
	 @FindBy(xpath="//*[@title=\"Add Social Link\"]//following::option[normalize-space(text())='Linkedin']")
	 WebElement SelectLinkedIn;
	 @FindBy(xpath="//a[contains(text(),'Link URL')]//following::input[2]")
	 WebElement LinkUrl;
	 @FindBy(xpath="//button[text()='Ok']")
	 WebElement Click_OK;
	 @FindBy(xpath="//a[normalize-space(text())='Link URL']//following::td[2]")
	 WebElement LinkVer;
	 @FindBy(xpath="//a[contains(text(),'Link URL')]")
	 WebElement ClickLinkurl;
	 //Adding Documents
	 ...
	 WebElement Save;
	 @FindBy(xpath="//span[normalize-space(text())='Documents']//following::td[1]")
	...
	// Initializing the Page Objects:
		...
		
		{
			...
			Repnameseacrh.sendKeys(prop.getProperty("Rep"));
	...
	public void click_RepDetail()
		{
			RepDetails.click();
			System.out.println("Clicked RepDetails Tab");
		}
		/*
		...
		public void clear_Type_MiddleName()
 {
			...
			Assert.assertEquals(Verification1, "Mars", "Rep MiddleName Doesn't match");
		...
		public void clear_Type_Fax()
		{
			...
			Fax_CT.sendKeys("1234567");
			SaveImage.click();
			String Verification1 =VerifyFax.getText();
			Assert.assertEquals(Verification1,"1234567","FaxNumber Doesn't match");
		...
		public void clear_Type_Website()
		{
			...
			Assert.assertEquals(Verification,"www.marsV10.com"+ Date ,"Rep Website Doesn't match");
			System.out.println("There should be an Website:" + Verification);
			log.info("Rep Website:" + Verification);
		 ...
		 public void clear_Type_RepTitle()
		 {
			...
			Title_CT.sendKeys("Mr"+ Date);
			 ...
			 Assert.assertEquals(Verification,"Mr"+Date,"Rep Title is not Matching");
		...
		public void clear_Type_RepNickName()
		{
			...
			Assert.assertEquals(Verification,"Phx"+Date,"Rep NickName is not Matching");
		...
		public void clear_Type_RepEmail()
		{
			...
			RepEmail_CT.sendKeys("marsID12@sfs.com");
			Save1.click();
			String Verification =VerifyRepEmail.getText();
			Assert.assertEquals(Verification,"marsID12@sfs.com","RepEmailID1 is not Matching");
		...
		public void clear_Type_PersonalInfo()
		{
			...
			SaveImage.click();
			String Verification =VerifyLastName.getText();
			Assert.assertEquals(Verification,"Rep_PersonalInfo"+Date,"RepPersonalInfo is not Matching");
			System.out.println("There should be an PersonalInfo:" + Verification);
			log.info("RepPersonalInfo:" + Verification);
		}
		public void clear_Type_Broker()
		{
			...
			Broker_CT.sendKeys("9");
			Save1.click();
			String Verification =VerifyLastName.getText();
			Assert.assertEquals(Verification,"9","RepBrokerInfo is not Matching");
			System.out.println(" # of Years as Broker :" + Verification);
			log.info("RepBroker :" + Verification);
		}
		public void clear_Type_AlternateName()
		{
			...
			SaveImage.click();
			String Verification =VerifyLastName.getText();
			Assert.assertEquals(Verification,"Rep_AlternateName"+Date,"RepAlternateNam is not Matching");
			System.out.println(" RepAlternateName :" + Verification);
			log.info("RepAlternateName :" + Verification);
		...
		public void clear_Type_Birthday()
		{
			...
			Birthday_CT.sendKeys("12/09");
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			Birthday_CTY.clear();
			Birthday_CTY.sendKeys("1990");
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			Save1.click();
			String Verification =VerifyLastName.getText();
			Assert.assertEquals(Verification,"12/09/1990","RepBirthday is not Matching");
			System.out.println(" RepBirthday :" + Verification);
			log.info("RepBirthday :" + Verification);
		}
		public void clear_Type_AUM()
		{
			...
			AUM_CT.sendKeys("2434");
			SaveImg2.click();
			String Verification =VerifyLastName.getText();
			Assert.assertEquals(Verification,"2,434","RepAUM is not Matching");
			System.out.println("RepTotal AUM :" + Verification);
			log.info("RepTotal AUM :" + Verification);
		...
		public void clear_Type_Spouse()
		{
			...
			SaveImage.click();
			String Verification =VerifyLastName.getText();
			Assert.assertEquals(Verification,"Spouse_info"+Date,"Rep Spouseinfo is not Matching");
			System.out.println("Rep Spouseinfo:" + Verification);
			log.info("Rep Spouseinfo:" + Verification);
		}
		public void clear_Type_Assistant()
		{
			...
			SaveImage.click();
			String Verification =VerifyLastName.getText();
			Assert.assertEquals(Verification,"Assistant_info"+Date,"RepAssistant info is not Matching");
			System.out.println("RepAssistant info:" + Verification);
			log.info("RepAssistant info:" + Verification);
		}
		public void clear_Type_PriorFirm()
		{
			...
			SaveImage.click();
			String Verification =VerifyLastName.getText();
			Assert.assertEquals(Verification,"Phoenix American"+Date,"Rep PriorFirm Details is not Matching");
			System.out.println("Rep PriorFirm Details:" + Verification);
			log.info("Rep PriorFirm Details:" + Verification);
		}
		public void clear_Type_UDF1()
		{
			...
			Assert.assertEquals(Verification,"98761.00","Rep UDF1 Details is not Matching");
			System.out.println("Rep UDF1 Details:" + Verification);
			log.info("Rep UDF1 Details:" + Verification);
			}
			catch(Exception exc){
				exc.printStackTrace();
				}
		...
		public void Social_link() {
			...
			WebElement VerifySocialLink = LinkVer;
			SelectLinkedIn.click();
			LinkUrl.click();
			LinkUrl.sendKeys("www.linkedin.com/company/phoenix-american/",Date);
			Click_OK.click();
			// ClickLinkurl.click();
			 action.doubleClick(ClickLinkurl).perform();

			 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			String VerifyingLink =VerifySocialLink.getText();
			Assert.assertEquals(VerifyingLink,"www.linkedin.com/company/phoenix-american/"+Date,"Social Link is not Matching");
			System.out.println("SocialLink Details:" + VerifyingLink);
			log.info("SocialLink Details:" + VerifyingLink);
		...
		public void Document() {
			...
			robot.setAutoDelay(1000);
				StringSelection stringSelection = new StringSelection("D:\\Workspace\\Mars10POMAutomation\\Documents\\ROBOT.txt");
			...
			repmaintab.click();
			 robot.setAutoDelay(1000);
			String DocVerification = DocumentVerification.getText();
			 Assert.assertEquals(DocVerification,"MarsV10"+Date,"RepProfile Document Verification Missmatch");
